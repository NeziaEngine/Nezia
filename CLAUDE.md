...
- [Source ワールド](docs/design/core/source.md) — コンポーネント定義、ピッチ内部表現の設計判断
...
- [PlayScheduled](docs/design/core/scheduling.md) — サンプル精度の予約再生 (Phase 3-4、`SourceState::Scheduled` + サブ callback offset)
- [Container (Random / Switch / Sequence)](docs/design/core/container.md) — メインスレッド完結型の再生指示解決 (Phase 4-2、現状 Random のみ)

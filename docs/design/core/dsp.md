...
| Phase 3-5 ParamEQ / Compressor | `EffectKind` への variant 追加 + 専用 World 追加で完了 (Compressor は Phase 3-3 Sidechain Ducking で先行実装済、PeakingEq も実装済 — 単体 Limiter エフェクトのみ未実装) |
